...
def c_mean_cluster(array,attributes,c,m):
	...
	fn=1
	for i in range(len(dataset)):
		if original_label[i]=='Yes' and predicted_label[i]=='Yes':
			acc+=1
			tp+=1
		elif original_label[i]=='No' and predicted_label[i]=='No':
			tn+=1
			acc+=1
		elif original_label[i]=='Yes' and predicted_label[i]=='No':
			fn+=1
		elif original_label[i]=='No' and predicted_label[i]=='Yes':
			fp+=1
